...
Given('slider value for user {string} is set to {string}', async function (this: Context, userNamespace: string, value: string) {
...
When('I drag the slider to the value from storage for {string}', async function (this: Context, userNamespace: string) {
...
Then('the slider value should match the one in storage for {string}', async function (this: Context, userNamespace: string) {
