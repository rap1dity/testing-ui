...
Given('a date {string} is set in storage for user {string}', async function (this: Context, date: string, userNamespace: string) {
...
When('I fill the date picker field using the stored date for {string}', async function (this: Context, userNamespace: string) {
...
Then('the date picker field should contain the stored date for {string}', async function (this: Context, userNamespace: string) {
